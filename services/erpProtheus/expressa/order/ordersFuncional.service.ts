...
import {
	ordersFuncionalResponseExpressaSchemaType,
	ordersFuncionalResponseExpressaSchema
} from '../../../../src/validator/erpProtheus/expressa/order/ordersFuncional.validator';
...
@Service({
	name: 'funcional.erpprotheusexpressa.orders',
...
export default class OrdersPostFuncionalService extends MoleculerService {
	...
	@Event({
		name: 'funcional.erpprotheusexpressa.post.orders',
		group: 'flow-funcional'
	})
		...
		try {
			...
			if (
				...
				const orderValidation =
					validatorFactory<ordersFuncionalResponseExpressaSchemaType>(
						ordersFuncionalResponseExpressaSchema
					);
				const bodyRecived =
					objReturn as ordersFuncionalResponseExpressaSchemaType;
	...
	@Event({
		name: 'funcional.erpprotheusexpressa.get.orders',
		group: 'flow-funcional'
	})
